...
#include "kuka_control/ControllerJointState.h"
		...
		bool init(hardware_interface::EffortJointInterface* hw, ros::NodeHandle &n)
  		{	
			...
			controller_state_pub_.reset(
				new realtime_tools::RealtimePublisher<kuka_control::ControllerJointState>(n, "state", 1));
	...
	private:
		...
		boost::scoped_ptr<
			realtime_tools::RealtimePublisher<
				kuka_control::ControllerJointState> > controller_state_pub_;
	};

}

PLUGINLIB_EXPORT_CLASS(kuka_control::GravityCompController, controller_interface::ControllerBase)
